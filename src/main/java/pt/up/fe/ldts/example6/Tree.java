...
public class Tree {
    ...
    public String toString() {
        return "Tree planted at " + this.plantedAt.toString() + " in location " + this.location.getLocationLatitude() + "," + this.location.locationLongitude + " (" + this.location.locationName + ")";
    }
    ...
    public boolean isNextAppraisalOverdue(){
        ...
        LocalDateTime latestAppraisalDate = localDateTime;
        ...
        return nextAppraisalDate.isBefore(localDateTime);
    }
}
